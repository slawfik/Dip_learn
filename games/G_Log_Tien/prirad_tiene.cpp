...
void PriradTiene::setNewGame()
{
    ...
    l_animal.push_back(new Animal(0,":/game/tiene/games/G_Log_tiene/textur/jezko.png"));
    tien = new Tiene(0);
    scene->addItem(tien);
    ...
    l_animal.push_back(new Animal(1,":/game/tiene/games/G_Log_tiene/textur/vtak.png"));
    tien = new Tiene(1);
    scene->addItem(tien);
    ...
    l_animal.push_back(new Animal(2,":/game/tiene/games/G_Log_tiene/textur/orol.png"));
    tien = new Tiene(2);
    scene->addItem(tien);
    ...
    l_animal.push_back(new Animal(3,":/game/tiene/games/G_Log_tiene/textur/ovecka.png"));
    tien = new Tiene(3);
    scene->addItem(tien);
    ...
    l_animal.push_back(new Animal(4,":/game/tiene/games/G_Log_tiene/textur/vevericka.png"));
    tien = new Tiene(4);
    scene->addItem(tien);
    ...
    l_animal.push_back(new Animal(5,":/game/tiene/games/G_Log_tiene/textur/zajacik.png"));
    tien = new Tiene(5);
    scene->addItem(tien);
